...
if ($_SERVER['REQUEST_METHOD'] === 'PUT' || $_SERVER['REQUEST_METHOD'] === 'PATCH') {
    ...
    // Check if it's a JSON payload (Recovery or Update) or Base64 (Login)
    ...
    // Handle Errors
    http_response_code(200); // Send 200 so frontend can read the error message
    echo $output; // FAILURE:...
    exit;
}
